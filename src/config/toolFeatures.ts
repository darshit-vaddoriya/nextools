...
export const PLANNED_FEATURES: Record<string, string[]> = {
  // ─── PDF ─────────────────────────────────────────────────────────
  'pdf-split':            ['Split by page ranges with preview', 'Extract individual pages as separate files', 'Split at every nth page', 'Download all parts as a ZIP'],
  'pdf-compress':         ['Adjustable compression level', 'Live before/after size comparison', 'Optimize images inside the PDF', 'Preserve text and layout quality'],
  ...
  'pdf-to-jpg':           ['Render each page to high-res JPG', 'Choose DPI and quality', 'Page-range selection', 'Download as ZIP archive'],
  'jpg-to-pdf':           ['Combine multiple JPGs into one PDF', 'Drag to reorder images', 'Adjust page size and margins', 'Optimize image quality vs size'],
  'pdf-to-png':           ['Transparent-background PNG output', 'Choose resolution per page', 'Select specific page ranges', 'Batch download as ZIP'],
  'png-to-pdf':           ['Merge PNGs into a single PDF', 'Support transparent backgrounds', 'Set custom page size', 'Reorder images freely'],
  ...
  'text-to-pdf':          ['Convert plain text and Markdown to PDF', 'Choose font size and spacing', 'Auto page break handling', 'Styled headings and lists'],
  'pdf-ocr':              ['Extract text from scanned PDFs', 'Built-in OCR with multi-language support', 'Copy or download recognized text', 'Keep text layer over the page'],
  'pdf-extract-text':     ['Pull all text from any PDF', 'Preserve paragraph structure', 'Export as .txt or .md', 'Copy to clipboard in one click'],
  'pdf-extract-images':   ['Extract every embedded image', 'Preview thumbnails before saving', 'Select and export individually', 'Download all as ZIP'],
  'pdf-rotate':           ['Rotate single or multiple pages', '90°, 180° and 270° rotation', 'Visual page thumbnails', 'Save rotated PDF locally'],
  'pdf-reorder':          ['Drag-and-drop page reordering', 'Live page thumbnails', 'Delete unwanted pages while reordering', 'Save new document instantly'],
  'pdf-delete-pages':     ['Remove pages by selection or range', 'Thumbnail preview before deleting', 'Undo support', 'Download the cleaned PDF'],
  ...
  'pdf-watermark':        ['Add text or image watermarks', 'Opacity, size and rotation control', 'Place on every page or selected ones', 'Diagonal and centered presets'],
  ...
  'pdf-page-numbers':     ['Add page numbers to any position', 'Custom format (1, 01, Page X of Y)', 'Skip first page option', 'Style and font control'],
  ...
  'pdf-sign':             ['Draw signatures with mouse or touch', 'Type or upload a signature image', 'Place signature anywhere on a page', 'Download signed PDF'],
  ...
  'pdf-redact':           ['Permanently black out sensitive text', 'Search-and-redact by keyword', 'Rectangular region redaction', 'Ensure text is truly removed'],
  'pdf-metadata':         ['View title, author and subject', 'Edit and update document properties', 'Strip personal metadata', 'See creation and modification dates'],
  ...
  'pdf-page-extractor':   ['Extract a custom page range', 'Preview pages before extraction', 'Split into multiple ranges', 'Save as a new PDF'],
...
const IMPLEMENTED = [
  ...
  'jwt-decoder', 'word-counter', 'text-counter', 'color-picker',
